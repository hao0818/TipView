...
TooltipFlow * add(NSString *str){
    ...
    if ([@"test_1" isEqualToString:str]) {
        [flow addTooltip:[[Tooltip alloc] initWithFlow:flow res:nil anchorViewId:@"tip_test"]];
        [flow addTooltip:[[Tooltip alloc] initWithFlow:flow res:nil anchorViewId:@"tip_test2"]];
